...
export interface OrderDetail_user_defaultShippingAddress_country {
...
export interface OrderDetail_user_defaultShippingAddress {
  __typename: "Address";
  /**
   ...
   */
  country: OrderDetail_user_defaultShippingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
...
export interface OrderDetail_user_defaultBillingAddress_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface OrderDetail_user_defaultBillingAddress {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: OrderDetail_user_defaultBillingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
   * Address is user's default billing address.
...
export interface OrderDetail_user_addresses_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface OrderDetail_user_addresses {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: OrderDetail_user_addresses_country;
  countryArea: string;
  phone: string | null;
  /**
   * Address is user's default billing address.
...
export interface OrderDetail_user {
  ...
  defaultShippingAddress: OrderDetail_user_defaultShippingAddress | null;
  defaultBillingAddress: OrderDetail_user_defaultBillingAddress | null;
  /**
   * List of all user's addresses.
   */
  addresses: (OrderDetail_user_addresses | null)[] | null;
}
