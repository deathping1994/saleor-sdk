...
export interface Checkout_subtotalPrice_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Checkout_subtotalPrice {
   ...
   * Amount of taxes.
   */
  tax: Checkout_subtotalPrice_tax;
}
...
export interface Checkout_shippingPrice_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Checkout_shippingPrice {
   ...
   * Amount of taxes.
   */
  tax: Checkout_shippingPrice_tax;
}
...
export interface Checkout_lines_variant_pricing_priceUndiscounted_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Checkout_lines_variant_pricing_priceUndiscounted {
   ...
   * Amount of taxes.
   */
  tax: Checkout_lines_variant_pricing_priceUndiscounted_tax;
}
...
export interface Checkout_lines_variant_pricing_price_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Checkout_lines_variant_pricing_price {
   ...
   * Amount of taxes.
   */
  tax: Checkout_lines_variant_pricing_price_tax;
}
...
export interface Checkout_lines_variant_product_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
...
export interface Checkout_lines_variant_product {
  ...
  weight: Checkout_lines_variant_product_weight | null;
