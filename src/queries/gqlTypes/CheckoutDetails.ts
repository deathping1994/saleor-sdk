...
export interface CheckoutDetails_checkout_totalPrice_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutDetails_checkout_totalPrice {
   ...
   * Amount of taxes.
   */
  tax: CheckoutDetails_checkout_totalPrice_tax;
}
...
export interface CheckoutDetails_checkout_subtotalPrice_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutDetails_checkout_subtotalPrice {
   ...
   * Amount of taxes.
   */
  tax: CheckoutDetails_checkout_subtotalPrice_tax;
}
...
export interface CheckoutDetails_checkout_shippingPrice_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutDetails_checkout_shippingPrice {
   ...
   * Amount of taxes.
   */
  tax: CheckoutDetails_checkout_shippingPrice_tax;
}
...
export interface CheckoutDetails_checkout_lines_totalPrice_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutDetails_checkout_lines_totalPrice {
   ...
   * Amount of taxes.
   */
  tax: CheckoutDetails_checkout_lines_totalPrice_tax;
}
...
export interface CheckoutDetails_checkout_lines_variant_pricing_priceUndiscounted_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutDetails_checkout_lines_variant_pricing_priceUndiscounted {
   ...
   * Amount of taxes.
   */
  tax: CheckoutDetails_checkout_lines_variant_pricing_priceUndiscounted_tax;
}
...
export interface CheckoutDetails_checkout_lines_variant_pricing_price_tax {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CheckoutDetails_checkout_lines_variant_pricing_price {
   ...
   * Amount of taxes.
   */
  tax: CheckoutDetails_checkout_lines_variant_pricing_price_tax;
}
...
export interface CheckoutDetails_checkout_lines_variant_product_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
