...
export interface UserOrderByToken_orderByToken_user_metadata {
...
export interface UserOrderByToken_orderByToken_user_defaultShippingAddress_country {
...
export interface UserOrderByToken_orderByToken_user_defaultShippingAddress {
  __typename: "Address";
  /**
   ...
   */
  country: UserOrderByToken_orderByToken_user_defaultShippingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
...
export interface UserOrderByToken_orderByToken_user_defaultBillingAddress_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface UserOrderByToken_orderByToken_user_defaultBillingAddress {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: UserOrderByToken_orderByToken_user_defaultBillingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
   * Address is user's default billing address.
...
export interface UserOrderByToken_orderByToken_user_addresses_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface UserOrderByToken_orderByToken_user_addresses {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: UserOrderByToken_orderByToken_user_addresses_country;
  countryArea: string;
  phone: string | null;
  /**
   * Address is user's default billing address.
...
export interface UserOrderByToken_orderByToken_user {
  __typename: "User";
  /**
   * The ID of the object.
   */
   ...
   */
  metadata: (UserOrderByToken_orderByToken_user_metadata | null)[];
  defaultShippingAddress: UserOrderByToken_orderByToken_user_defaultShippingAddress | null;
  defaultBillingAddress: UserOrderByToken_orderByToken_user_defaultBillingAddress | null;
  /**
   * List of all user's addresses.
   */
  addresses: (UserOrderByToken_orderByToken_user_addresses | null)[] | null;
}
...
export interface UserOrderByToken_orderByToken {
   ...
   */
  number: string | null;
  user: UserOrderByToken_orderByToken_user | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
