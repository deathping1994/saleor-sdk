...
export interface OrderByToken_orderByToken_user_defaultShippingAddress_country {
...
export interface OrderByToken_orderByToken_user_defaultShippingAddress {
  __typename: "Address";
  /**
   ...
   */
  country: OrderByToken_orderByToken_user_defaultShippingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
...
export interface OrderByToken_orderByToken_user_defaultBillingAddress_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface OrderByToken_orderByToken_user_defaultBillingAddress {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: OrderByToken_orderByToken_user_defaultBillingAddress_country;
  countryArea: string;
  phone: string | null;
  /**
   * Address is user's default billing address.
...
export interface OrderByToken_orderByToken_user_addresses_country {
  __typename: "CountryDisplay";
  /**
   * Country code.
   */
...
export interface OrderByToken_orderByToken_user_addresses {
  __typename: "Address";
  /**
   * The ID of the object.
   */
   ...
   * Shop's default country.
   */
  country: OrderByToken_orderByToken_user_addresses_country;
  countryArea: string;
  phone: string | null;
  /**
   * Address is user's default billing address.
...
export interface OrderByToken_orderByToken_user {
  ...
  defaultShippingAddress: OrderByToken_orderByToken_user_defaultShippingAddress | null;
  defaultBillingAddress: OrderByToken_orderByToken_user_defaultBillingAddress | null;
  /**
   * List of all user's addresses.
   */
  addresses: (OrderByToken_orderByToken_user_addresses | null)[] | null;
}
...
export interface OrderByToken_orderByToken_lines_variant_product_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
